...
export default function SearchBox() {
  ...
  const styles = {
    ...
    query:
      "backdrop-blur placeholder-shown:backdrop-blur focus:backdrop-blur-none",
    listbox: "w-full bg-white/10 backdrop-blur shadow-glass",
    item: "px-4 py-2",
    highlightedItem: "px-6 py-2 bg-white/10 cursor-pointer",
    match: "text-bold",
    typeahead: "text-gray-400 backdrop-blur",
    clearButton:
  ...
  return (
    <div className='className="w-80 md:w-96 lg:w-[32rem] sm:mr-2'>
      <Turnstone
        id="search"
        name="search"
        clearButton={true}
